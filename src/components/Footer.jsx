            ...
            <div className='px-2 md:px-5 lg:px-16 xl:px-20 2xl:px-32 mx-auto  text-white'>
                ...
                <div className='flex flex-col md:flex-row justify-between items-center py-10 gap-5'>
                    ...
                    <div className='flex gap-3'>
                        <div className='group h-11 w-11 bg-white hover:bg-[#0147FF] flex items-center justify-center'>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.6663 11.2503H13.7497L14.583 7.91699H11.6663V6.25033C11.6663 5.39251 11.6663 4.58366 13.333 4.58366H14.583V1.78374C14.3116 1.7477 13.2855 1.66699 12.2021 1.66699C9.94001 1.66699 8.33301 3.04771 8.33301 5.58342V7.91699H5.83301V11.2503H8.33301V18.3337H11.6663V11.2503Z" className="fill-[#00206D] group-hover:fill-white" />
                        </svg>
                        </div>
                        <div className="group h-11 w-11 bg-white hover:bg-[#0147FF] flex items-center justify-center text-[#00206D] hover:text-white">
                            <svg
                                width="20"
                                height="20"
                                viewBox="0 0 20 20"
